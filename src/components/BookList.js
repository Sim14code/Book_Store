...
//   useEffect(() => {
//     const user = localStorage.getItem("loggedInUser"); // Get the logged-in username from localStorage

//     if (user) {
//       // Fetch books for the specific user from the Django backend
//       fetch(`http://127.0.0.1:8000/api/${user}/books/`) // Correct URL for API
